...
trip_tib <- trip_tib_2000 %>%
  filter(exp_pool  %in% c("mean_RSTP2_2000_LBR2_DMSO_split_64", "mean_RSTP2_2000_LBR2_NU7441_split_64", "mean_RSTP2_2000_LBR2_DMSO_ssODN_split_64", "mean_RSTP2_2000_LBR2_NU7441_ssODN_split_64"))
...
exp_order <- c("mean_RSTP2_2000_LBR2_DMSO_split_64",
              "mean_RSTP2_2000_LBR2_NU7441_split_64",
              "mean_RSTP2_2000_LBR2_DMSO_ssODN_split_64",
              "mean_RSTP2_2000_LBR2_NU7441_ssODN_split_64")
...
p + scale_fill_manual("legend", values = colores) +
  scale_x_discrete(labels=c("mean_RSTP2_2000_LBR2_DMSO_split_64" = "DMSO",
                            "mean_RSTP2_2000_LBR2_NU7441_split_64" = "ssODN + DMSO",
                            "mean_RSTP2_2000_LBR2_DMSO_ssODN_split_64" = "NU7441",
                            "mean_RSTP2_2000_LBR2_NU7441_ssODN_split_64" = "ssODN + NU7441")) +
...
pathway_distribution <- trip_tib %>%
  filter(exp_pool == "mean_RSTP2_2000_LBR2_DMSO_ssODN_split_64") %>%
...
indel.dt = unique(tib.dt[exp_pool == "mean_RSTP2_2000_LBR2_DMSO_ssODN_split_64",  
...
plot_comb_grid(indel.dt[exp_pool=='mean_RSTP2_2000_LBR2_DMSO_ssODN_split_64'], opt_df,
...
SSTR_indels = filter(trip_tib_mut, exp_pool %in% c("mean_RSTP2_2000_LBR2_DMSO_ssODN_split_64", "mean_RSTP2_2000_LBR2_NU7441_ssODN_split_64"))
