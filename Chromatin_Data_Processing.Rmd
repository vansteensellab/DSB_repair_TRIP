...
ChIP_mean_data = readRDS("/DATA/projects/DSBrepair/data/R/cl20200108_ChIP_mean_selection.RDS")
ChIP_meta <- readRDS("/DATA/projects/DSBrepair/data/R/cl20200108_ChIP_meta_selection.RDS")
...
chip.domains.dt = rep.dt[!target %in% c('SPIN-10state', 'SPIN-100kb'), ]
...
clone_file.dt = data.table(str_match(clone_file_list, '.*/clone(.*).txt'))
...
chip_domains.dt[, pool := gsub("clone5", "RSTP2_clone5", pool, perl = TRUE)]
...
trip_tib <- dplyr::select(trip_tib, !c("H3K9me3", "H3K9me3_domain"))
```
