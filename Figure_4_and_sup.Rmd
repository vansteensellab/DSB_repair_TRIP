...
#
plot_comb_grid(indel.dt[exp_pool=='indel_mean_LBR2_DMSO_64h'], opt_df,
                   domain_levels, 'H3K4me1', min_count = 20)


indel.dt = unique(tib.dt[exp_pool =="indel_mean_LBR2_DMSO_64h",
                         c('exp_pool', 'barcode', 'H3K9me2',
                           domains), with=F])
colnames(indel.dt) = gsub('K9me2$', 'K9me2_sig', colnames(indel.dt))
...
#
plot_comb_grid(indel.dt[exp_pool=='indel_mean_LBR2_DMSO_64h'], opt_df,
                   domain_levels, 'H3K9me2_sig', min_count = 20)

indel.dt = unique(tib.dt[exp_pool =="indel_mean_LBR2_DMSO_64h",
                         c('exp_pool', 'barcode', 'H3K9me3',
                           domains), with=F])
colnames(indel.dt) = gsub('K9me3$', 'K9me3_sig', colnames(indel.dt))
indel.dt[indel.dt=='iDomain'] <- 0
indel.dt[indel.dt=='Domain'] <- 1
...
#
plot_comb_grid(indel.dt[exp_pool=='indel_mean_LBR2_DMSO_64h'], opt_df,
                   domain_levels, 'H3K9me3_sig', min_count = 20)
```
