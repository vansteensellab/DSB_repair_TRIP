...
plot_comb_grid_beeswarm(indel.dt, opt_df,
                        domain_levels, 'GSK_ratio', min_count = 1)
...
```{r}
clone5_domains <- readRDS("/DATA/projects/DSBrepair/data/R/rs20200311_domains_clone5.RDS") %>% as_tibble()

trip_tib_clone5_GSK126 <- trip_tib_2000 %>%
    filter(exp_pool  %in% c("mean_RSTP2_clone5_LBR2_DMSOGSK_64",
                            "mean_RSTP2_clone5_LBR2_GSK126_64",
                            "indel_Clone5GSKBIXRep1_clone5_LBR2_GSK126_64",
                            "indel_Clone5GSKBIXRep2_clone5_LBR2_GSK126_64",
                            "indel_Clone5GSKBIXRep3_clone5_LBR2_GSK126_64",
                            "indel_Clone5GSKBIXRep1_clone5_LBR2_DMSO_64",
                            "indel_Clone5GSKBIXRep2_clone5_LBR2_DMSO_64",
                            "indel_Clone5GSKBIXRep3_clone5_LBR2_DMSO_64")) %>% 
  left_join(clone5_domains, by = "barcode") %>% 
  mutate(drug = ifelse(drug %in% c("DMSO", "DMSO_GSK"), "DMSO", "GSK126"), 
         repli_plotting = ifelse(replicate == "mean", "mean", "single"),
         group = ifelse(group == "late_replicating-LAD-H3K9me2", "triple", ifelse(group %in% c("LAD-H3K9me2", "late_replicating-H3K9me2", "late_replicating"), "other", group)))

# Box plot facetted by "dose"
p <- ggpaired(filter(trip_tib_clone5_GSK126, replicate != "mean"), x = "drug", y = "MMEJ_MMEJNHEJ",
              color = "drug", palette = "jco", 
              line.color = "gray", line.size = 0.4,
              facet.by = "group", short.panel.labs = FALSE)
# Use only p.format as label. Remove method name.
...
trip_tib_clone5_GSK126 <- trip_tib_2000 %>%
    filter(exp_pool  %in% c("mean_RSTP2_clone5_LBR2_DMSOGSK_64",
                            "mean_RSTP2_clone5_LBR2_GSK126_64",
                            "indel_Clone5GSKBIXRep1_clone5_LBR2_BIX01294_64",
                            "indel_Clone5GSKBIXRep2_clone5_LBR2_GSK126_64",
                            "indel_Clone5GSKBIXRep3_clone5_LBR2_GSK126_64",
                            "indel_Clone5GSKBIXRep1_clone5_LBR2_DMSO_64",
                            "indel_Clone5GSKBIXRep2_clone5_LBR2_DMSO_64",
...
```{r 6FG, fig.height= 6, fig.width= 6}
...
## Supplementary
### Panel S6A
```{r S6A, fig.height=5, fig.width=7}
...
### SXA
```{r SXA, fig.height 6, fig.width=7}
ipr = clone5_domains_damid %>% filter(IPR == "IPR17")
...
### SXB
```{r SXB, fig.height= 6, fig.width= 7}
ipr = clone5_domains_damid %>% filter(IPR == "IPR2")
...
### SXC
```{r SXC, fig.height= 8, fig.width= 8}
