...
file.list <- list.files(path = "/DATA/projects/DSBrepair/data/rs20190730_TRIP/parsed/", pattern="mapping*.*statistics.txt", full.names = TRUE)
...
file.list <- list.files(path = "/DATA/projects/DSBrepair/data/rs20190730_TRIP/table/", pattern="*.table", full.names = TRUE)
...
# Load metadata
metadata <- read.table("/DATA/projects/DSBrepair/config/rs20200107_metadata_Repair_TRIP.tsv", header = TRUE, stringsAsFactors = FALSE) %>% as_tibble()
```
